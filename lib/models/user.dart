...
class User extends Equatable {
  ...
  Map<String, dynamic> toJson({bool includePassword = false}) {
    // Create map without null values
    final map = <String, dynamic>{};

    if (id != null) map['id'] = id;
    if (userName != null) map['user_name'] = userName;
    if (role != null) map['role'] = role;
    if (controlUnit != null) map['control_unit'] = controlUnit;
    if (technicalId != null) map['technical_id'] = technicalId;

    if (includePassword && userPassword != null) {
